...
class Player {
  ...
  bind() {
    ...
    this.swiper.on('swipRight', function() {
      console.log('sR', this)
      this.classList.remove('panel2')
      this.classList.add('panel1')
    })
    this.swiper.on('swipLeft', function() {
      console.log('sL', this)
  ...
  locateLyric() {
    ...
    if(currentTime > nextLineTime && this.lyricIndex < this.lyricsArr.length - 1) {
      ...
      if(this.$$('.panel-effect .lyric p')[0] ) this.$$('.panel-effect .lyric p')[0].innerText = this.lyricsArr[this.lyricIndex][1]
      if(this.$$('.panel-effect .lyric p')[1]) this.$$('.panel-effect .lyric p')[1].innerText = this.lyricsArr[this.lyricIndex+1] ? this.lyricsArr[this.lyricIndex+1][1] : ''
    }
  }
  ...
  setProgerssBar() {
    ...
    console.log(percent)
    this.$('.bar .process').style.width = percent
    this.$('.time-start').innerText = this.formateTime(this.audio.currentTime)
    console.log(this.$('.bar .process').style.width)
  }
